...
class AnthropicProvider(BaseAIProvider):
    """Anthropic Claude provider for speech analysis."""
    ...
    def analyze_argument_structure(self, transcription: str) -> ArgumentStructure:
        """Analyze argument structure using Claude."""
        ...
        try:
            ...
            logger.error(f"Anthropic structure analysis failed: {e}")
            raise
    
    def analyze_word_choice(self, transcription: str) -> WordChoiceAnalysis:
        """Analyze word choice using Claude."""
        ...
        try:
            ...
            logger.error(f"Anthropic word choice analysis failed: {e}")
            raise
    ...
    def generate_score(
        ...
        """Generate overall score using Claude."""
